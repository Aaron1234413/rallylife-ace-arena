-- Phase 1: Backend Foundation & Fixes (Fixed constraint version)
...
-- First update the constraint to include 'community'
...
-- Update all references to 'free' tier
