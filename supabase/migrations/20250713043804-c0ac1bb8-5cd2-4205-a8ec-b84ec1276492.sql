-- Drop all possible variations of complete_session_unified function
DO $$
DECLARE
    func_record RECORD;
BEGIN
    ...
    LOOP
        ...
        RAISE LOG 'Dropped function: public.%(%)', func_record.proname, func_record.args;
    END LOOP;
END $$;

-- Now create the enhanced complete_session_unified function
CREATE FUNCTION public.complete_session_unified(
...
-- Ensure supporting functions exist
...
-- Ensure add_tokens function exists  
