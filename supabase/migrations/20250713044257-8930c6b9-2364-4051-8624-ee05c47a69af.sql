-- First drop ALL variations of complete_session_unified function
DO $$
DECLARE
    func_record RECORD;
    func_signature TEXT;
BEGIN
    ...
    FOR func_record IN 
        ...
        WHERE p.proname = 'complete_session_unified'
        AND n.nspname = 'public'
    LOOP
        func_signature := format('%s.%s(%s)', 
...
-- Now create the enhanced complete_session_unified function from scratch
