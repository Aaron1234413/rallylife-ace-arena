-- Fix stakes distribution logic to correct requirements
-- Competitive matches: Winner takes 100% (no organizer fee)
-- Doubles: Split 50/50 between winning team members
-- Social/Training: Organizer 60%, participants split 40%
