-- Drop and recreate the add_tokens function with correct signature
...
BEGIN
  ...
  BEGIN
    ...
    -- Log activity (optional, best effort - don't fail if this fails)
    BEGIN
...
-- Create supporting function lose_hp
...
-- Create add_tokens function with correct signature
