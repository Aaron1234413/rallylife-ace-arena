...
DO $$
BEGIN
  -- Check and create "Users can view session participants" policy
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'session_participants' 
    AND policyname = 'Users can view session participants'
  ) THEN
  ...
  -- Check and create "Users can join sessions" policy
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'session_participants' 
    AND policyname = 'Users can join sessions'
  ) THEN
  ...
  -- Check and create "Users can leave sessions" policy
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'session_participants' 
    AND policyname = 'Users can leave sessions'
  ) THEN
