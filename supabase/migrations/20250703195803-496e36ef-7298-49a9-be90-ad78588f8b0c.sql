-- Insert mock coach and player profiles
INSERT INTO public.profiles (id, full_name, role, avatar_url, created_at) VALUES
-- Mock Coaches
('11111111-1111-1111-1111-111111111111', 'Sven Lah', 'coach', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face', now()),
('22222222-2222-2222-2222-222222222222', 'Pierre Montolegro', 'coach', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face', now()),
('33333333-3333-3333-3333-333333333333', 'Gene Gaiser', 'coach', 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=150&h=150&fit=crop&crop=face', now()),
('44444444-4444-4444-4444-444444444444', 'Shawn Stillman', 'coach', 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150&h=150&fit=crop&crop=face', now()),
('55555555-5555-5555-5555-555555555555', 'Shawn Meiser', 'coach', 'https://images.unsplash.com/photo-1566492031773-4f4e44671d66?w=150&h=150&fit=crop&crop=face', now()),
-- Mock Players
('66666666-6666-6666-6666-666666666666', 'Alex Chen', 'player', 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=150&h=150&fit=crop&crop=face', now()),
('77777777-7777-7777-7777-777777777777', 'Maria Garcia', 'player', 'https://images.unsplash.com/photo-1494790108755-2616b9f71174?w=150&h=150&fit=crop&crop=face', now()),
('88888888-8888-8888-8888-888888888888', 'John Smith', 'player', 'https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=150&h=150&fit=crop&crop=face', now()),
('99999999-9999-9999-9999-999999999999', 'Emma Wilson', 'player', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face', now()),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'David Lee', 'player', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face', now()),
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Sophie Brown', 'player', 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=150&h=150&fit=crop&crop=face', now()),
('cccccccc-cccc-cccc-cccc-cccccccccccc', 'James Wilson', 'player', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face', now())
