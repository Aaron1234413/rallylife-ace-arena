-- Fix activity_type constraint and record array issue in complete_session_unified function
...
BEGIN
  ...
  RAISE LOG 'complete_session_unified: Found % participants with % total stakes', participant_count, total_stakes;
  ...
  LOOP
    RAISE LOG 'complete_session_unified: Processing participant user_id=%', participant_record.user_id;
