-- Drop existing complete_session_unified function variations
DROP FUNCTION IF EXISTS public.complete_session_unified(UUID, TEXT, INTEGER, INTEGER, BOOLEAN, INTEGER, INTEGER, JSONB);
DROP FUNCTION IF EXISTS public.complete_session_unified(UUID, TEXT, INTEGER, INTEGER, BOOLEAN, INTEGER, INTEGER);
DROP FUNCTION IF EXISTS public.complete_session_unified(UUID, TEXT, INTEGER, INTEGER, BOOLEAN, INTEGER);
DROP FUNCTION IF EXISTS public.complete_session_unified(UUID, TEXT, INTEGER, INTEGER, BOOLEAN);
DROP FUNCTION IF EXISTS public.complete_session_unified(UUID, TEXT, INTEGER, INTEGER);
DROP FUNCTION IF EXISTS public.complete_session_unified(UUID, TEXT, INTEGER);
...
-- Create or update supporting functions
...
-- Create or update add_tokens function
...
BEGIN
  ...
  IF balance_record IS NULL THEN
    INSERT INTO public.token_balances (player_id, regular_tokens, premium_tokens, lifetime_tokens_earned)
