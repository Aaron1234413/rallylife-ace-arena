...
export function StoreItemCard({ item, regularTokens, onPurchase }: StoreItemCardProps) {
  ...
  return (
    <Card className={`group relative transition-all duration-200 hover:shadow-sm border-gray-200 bg-white h-full flex flex-col ${isExpanded ? 'ring-1 ring-tennis-green-primary shadow-sm' : ''}`}>
