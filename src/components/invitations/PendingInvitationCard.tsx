...
export const PendingInvitationCard: React.FC<InvitationCardProps> = ({ invitation }) => {
  const styles = useInvitationStyles(invitation, 'sent');

  return (
    <Card className={styles.cardStyle}>
      <CardHeader className="pb-3">
        <CardTitle>
          <InvitationHeader invitation={invitation} variant="sent" />
        </CardTitle>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <InvitationActions invitation={invitation} variant="cancel" />
      </CardContent>
    </Card>
  );
};
