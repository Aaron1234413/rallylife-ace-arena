...
export default function Landing() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-tennis-green-bg via-tennis-green-bg-alt to-tennis-green-medium/20 text-white overflow-hidden relative">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-6xl mx-auto space-y-12">
            ...
            <CRTMonitor title="MAIN TERMINAL" size="large">
              <div className="text-center py-8 px-4 bg-tennis-green-bg/90 rounded-lg">
                ...
                <p className="text-lg md:text-xl text-tennis-green-dark font-poppins max-w-2xl mx-auto leading-relaxed mb-8">
            ...
            <div className="flex justify-center">
              <div className="w-full max-w-2xl">
                <CRTMonitor title="COMMAND INTERFACE" size="medium">
                  <div className="p-4 bg-tennis-green-bg/90 rounded">
                    <InteractiveTerminal />
                  </div>
                </CRTMonitor>
              </div>
                ...
                <CRTMonitor title="GAME PREVIEW" size="medium">
                  <div className="p-4 bg-tennis-green-bg/90 rounded">
                    ...
                    <div className="mt-4 text-center">
                      <div className="text-xs text-tennis-green-dark font-orbitron tracking-wider uppercase">
              ...
              <div className="text-center py-8 px-4 bg-tennis-green-bg/90 rounded-lg">
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col items-center space-y-2">
                    <p className="text-tennis-green-dark/70 text-sm font-orbitron tracking-wider">
                      [ STATUS: READY FOR LAUNCH ]
                    </p>
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-tennis-green-primary rounded-full animate-pulse" />
                      <span className="text-xs text-tennis-green-dark font-orbitron tracking-widest">
                        SYSTEM ONLINE
                      </span>
                    </div>
                  </div>
