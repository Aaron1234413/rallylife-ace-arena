      ...
      <div className="min-h-screen bg-tennis-green-bg">
        <div className="container mx-auto px-4 py-6 sm:py-8 max-w-2xl">
          <div className="text-center mb-6 sm:mb-8 space-y-2">
            ...
            <h1 className="orbitron-heading text-display sm:text-hero text-tennis-green-dark tracking-tight">
              Activity Feed
            </h1>
            <p className="poppins-body text-body-lg text-tennis-green-medium">
              ...
              <Card key={i} className="animate-pulse bg-white/95 backdrop-blur-sm border-white/20 shadow-xl">
                <CardContent className="p-6">
                  <div className="flex items-start gap-3 mb-4">
                    <div className="w-12 h-12 bg-tennis-green-subtle rounded-full" />
                    <div className="flex-1">
                      <div className="h-5 bg-tennis-green-subtle rounded mb-2" />
                      <div className="h-4 bg-tennis-green-subtle rounded w-3/4" />
                    </div>
                  </div>
                  <div className="h-20 bg-tennis-green-subtle rounded mb-4" />
                  <div className="flex justify-between">
                    <div className="flex gap-4">
                      <div className="h-6 w-12 bg-tennis-green-subtle rounded" />
                      <div className="h-6 w-12 bg-tennis-green-subtle rounded" />
                    </div>
                  </div>
                </CardContent>
