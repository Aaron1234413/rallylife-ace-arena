  ...
  const createSession = async (sessionData: Partial<Session>) => {
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        latitude: (sessionData as any).latitude,
        longitude: (sessionData as any).longitude,
        location_coordinates_set: !!(sessionData as any).latitude && !!(sessionData as any).longitude,
